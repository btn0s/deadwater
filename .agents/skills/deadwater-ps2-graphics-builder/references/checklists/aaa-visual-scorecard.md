...
Use with `deadwater-ps2-graphics-builder/references/visual-scorecard.md`.
...
- No automatic failure is present: check every item in the canonical Automatic Failures list in `deadwater-ps2-graphics-builder/references/visual-scorecard.md` (do not rely on a from-memory summary of it).
