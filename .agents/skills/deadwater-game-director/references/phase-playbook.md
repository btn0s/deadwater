...
- Chosen sources per surface: procedural / deadwater-image-generator / deadwater-3d-asset-pipeline / deadwater-audio-generator / hybrid
...
Do not write `not-needed` for a generator skill before loading it when trigger surfaces are present. The hero-surface evidence rule is in `deadwater-game-director/SKILL.md` (External Asset Sourcing Gate).

## Required References

Load these files before the matching phase starts:

- Gameplay systems: `deadwater-gameplay-systems/references/gameplay-workflows.md`
- Game design and level design, for broad new-game creation, major gameplay upgrades, level/arena/track/wave/hole/puzzle work, encounter design, progression/difficulty work, or premium gameplay claims: `deadwater-gameplay-systems/references/game-design-level-design.md`
- Game feel, for feel/juice/impact tuning or any premium/polished gameplay claim: `deadwater-gameplay-systems/references/game-feel.md`
- Physics selection, when physics/collision-heavy gameplay is in scope: `deadwater-gameplay-systems/references/physics-engine-selection.md`
- New-game checklist, when creating a game or first playable slice: `deadwater-gameplay-systems/references/checklists/new-game-definition-of-done.md`
- Game design and level design checklist, when creating a game, upgrading major gameplay, designing levels/encounters, or claiming premium gameplay: `deadwater-gameplay-systems/references/checklists/game-design-level-design.md`
- Game feel checklist, when tuning feel or claiming premium gameplay: `deadwater-gameplay-systems/references/checklists/game-feel.md`
- Endless runner checklist, when building or upgrading an endless runner: `deadwater-gameplay-systems/references/checklists/endless-runner-premium-quality.md`
- AAA graphics, for any graphics phase: `deadwater-ps2-graphics-builder/references/visual-scorecard.md`, `deadwater-ps2-graphics-builder/references/implementation-blueprint.md`, `deadwater-ps2-graphics-builder/references/model-recipes.md`, and `deadwater-ps2-graphics-builder/references/render-recipes.md`
- Shader and material cookbook, for premium/AAA/showcase graphics or custom shader/material/post-processing work: `deadwater-ps2-graphics-builder/references/shader-cookbook.md`
- Technical art, for premium/AAA/showcase graphics, shaders/material systems, VFX systems, generated/imported asset cleanup, LOD/instancing, or visual performance work: `deadwater-ps2-graphics-builder/references/technical-art.md`
- AAA graphics checklists, for premium/AAA/showcase claims: `deadwater-ps2-graphics-builder/references/checklists/aaa-game-quality-gate.md` and `deadwater-ps2-graphics-builder/references/checklists/aaa-visual-scorecard.md`
- Technical art checklist, for premium/AAA/showcase graphics or visual performance claims: `deadwater-ps2-graphics-builder/references/checklists/technical-art-quality.md`
- UI: `deadwater-game-ui-designer/references/ui-patterns.md`
- UI checklists, when UI/HUD/menu/touch layout is in scope: `deadwater-game-ui-designer/references/checklists/game-ui-quality.md`, `deadwater-game-ui-designer/references/checklists/hud-readability.md`, and `deadwater-game-ui-designer/references/checklists/responsive-ui-fit.md`
- Debug/profile: `deadwater-debug-profiler/references/debug-profile-checklists.md`, plus `deadwater-debug-profiler/references/checklists/scene-debugging.md` or `deadwater-debug-profiler/references/checklists/performance-profile.md` when debugging or profiling
- QA/release: `deadwater-qa-release/references/qa-release-checklists.md`, plus for final verification `deadwater-qa-release/references/checklists/visual-verification.md`, `deadwater-qa-release/references/checklists/playtest-qa.md`, and `deadwater-qa-release/references/checklists/release.md`
- Visual test harness, when premium/release-ready visual QA, generated asset visibility, UI regression protection, or screenshot baselines are warranted: `deadwater-qa-release/references/visual-test-harness.md` and `deadwater-qa-release/references/checklists/visual-test-harness.md`
- Bot playtest, for release-ready gameplay claims or difficulty/fairness verification: `deadwater-qa-release/references/playtest-bot.md` and `deadwater-qa-release/references/checklists/bot-playtest.md`
- 3D generator, when loaded by the external asset sourcing gate: `deadwater-3d-asset-pipeline/references/api-notes.md` and `deadwater-3d-asset-pipeline/references/threejs-integration.md`
- 3D plus image generator, when both are loaded: `deadwater-3d-asset-pipeline/references/image-generator-workflows.md`
- Audio generator, when loaded for a game: `deadwater-audio-generator/references/audio-workflows.md`
...
- Load `deadwater-3d-asset-pipeline`, `deadwater-image-generator`, and/or `deadwater-audio-generator` when their trigger surfaces exist, plus their required references.
- Decide source per high-value surface: procedural / deadwater-image-generator / deadwater-3d-asset-pipeline / deadwater-audio-generator / hybrid.
...
- For premium/AAA claims, run the fresh-eyes scorecard review per `deadwater-ps2-graphics-builder/references/visual-scorecard.md`.
